...
def run_python_executor(
    *,
    ...
    build_runtime: Callable[..., Any] = build_python_executor_runtime,
) -> int:
...
def main(
    *,
    ...
    run_executor: Callable[..., int] = run_python_executor,
) -> int:
    ...
    return run_executor(
        handlers=handlers,
        executor_id=resolved_env.get("IKAM_EXECUTOR_ID", "executor://python-primary"),
        consumer_group_id=resolved_env.get("IKAM_EXECUTOR_CONSUMER_GROUP_ID", "python-executor-group"),
